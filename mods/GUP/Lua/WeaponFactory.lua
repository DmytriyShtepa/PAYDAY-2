...
--Stubby Compensator
if GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 2 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 8 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 9 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 10 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._stubby_compensator == 11 then
	hide("wpn_fps_upg_ns_ass_smg_stubby")
end

--Tank Compensator
if GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 2 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 8 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 9 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 10 then
	hide("wpn_fps_upg_ns_ass_smg_tank")
	tweak_data.weapon.factory.parts.wpn_fps_upg_ns_ass_smg_tank.adds = { "wpn_fps_upg_ak_bayonet" }
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tank_compensator == 11 then
	hide("wpn_fps_upg_ns_ass_smg_tank")
end

--Fire Breather Nozzle
if GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 2 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 8 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 9 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 10 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._fire_breather == 11 then
	hide("wpn_fps_upg_ns_ass_smg_firepig")
end

--Competitor's Compensator
if GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 2 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 8 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 9 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 10 then
	hide("wpn_fps_upg_ass_ns_jprifles")
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_ns_jprifles.adds = { "wpn_fps_upg_ak_bayonet" }
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._competitors_compensator == 11 then
	hide("wpn_fps_upg_ass_ns_jprifles")
end

--Funnel of Fun Nozzle
if GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 2 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 8 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 9 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 10 then
	hide("wpn_fps_upg_ass_ns_linear")
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_ns_linear.adds = { "wpn_fps_upg_ak_bayonet" }
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._funnel_of_fun == 11 then
	hide("wpn_fps_upg_ass_ns_linear")
end

--Tactical Compensator
if GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 2 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 8 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 9 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 10 then
	hide("wpn_fps_upg_ass_ns_surefire")
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_ns_surefire.adds = { "wpn_fps_upg_ak_bayonet" }
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._tactical_compensator == 11 then
	hide("wpn_fps_upg_ass_ns_surefire")
end

--Ported Compensator
if GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 2 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 8 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 9 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 10 then
	hide("wpn_fps_upg_ass_ns_battle")
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_ns_battle.adds = { "wpn_fps_upg_ak_bayonet" }
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._ported_compensator == 11 then
	hide("wpn_fps_upg_ass_ns_battle")
end

--Shark Teeth Nozzle
if GageUpgradeOptions._opts.GlobalOpt.Extensions._shark_teeth == 2 then	
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._shark_teeth == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._shark_teeth == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._shark_teeth == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._shark_teeth == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._shark_teeth == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._shark_teeth == 8 then
...
if GageUpgradeOptions._opts.GlobalOpt.Extensions._kings_crown == 2 then	
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._kings_crown == 3 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._kings_crown == 4 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._kings_crown == 5 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._kings_crown == 6 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._kings_crown == 7 then
...
elseif GageUpgradeOptions._opts.GlobalOpt.Extensions._kings_crown == 8 then
...
--	Flash Hider
if GageUpgradeOptions._opts.GlobalOpt.Extensions._flash_hider == 2 then
...
local car4_gadget_positions = {
	...
	top = "a_obj = \"a_fl_2\", parent = \"ksg\", forbids = {\"wpn_fps_addon_ris\"}, adds = {\"g17_unit\"}, override = { g17_unit = { adds = {\"ksg_unit\"}, override = { ksg_unit = {parent = \"g17\"}}}}, ",
...
local barrels = {
	short_dummy = {
		unit_name = "wpn_fps_m4_uupg_b_short_vanilla",
		units = ""
	},
...
local fg = {
	rail = { 
		...
		override = "wpn_fps_ass_m16_os_frontsight = { parent = \"amcar\"}, wpn_fps_upg_o_dd_rear = {parent = \"L85A2\", a_obj = \"a_o\", adds = {\"L85A2_unit\", \"wpn_fps_upg_o_dd_front\"}}, wpn_fps_upg_o_dd_front = {a_obj = \"a_os\", parent = \"foregrip\"}, wpn_fps_upg_o_mbus_rear = { parent = \"L85A2\", a_obj = \"a_o\", stats = {value = 1}, adds = {\"L85A2_unit\", \"wpn_fps_upg_o_mbus_front\"}},wpn_fps_upg_o_mbus_front = {a_obj = \"a_os\", parent = \"foregrip\"}"
	},
	lr300 = { 
		...
		override = "wpn_fps_ass_m16_os_frontsight = { a_obj = \"a_ns\", parent = \"extender\", adds = {\"extender_ap\"}}, wpn_fps_upg_o_dd_rear = {parent = \"L85A2\", a_obj = \"a_o\", adds = {\"L85A2_unit\", \"wpn_fps_upg_o_dd_front\"}}, wpn_fps_upg_o_dd_front = {a_obj = \"a_os\", parent = \"foregrip\"}, wpn_fps_upg_o_mbus_rear = {parent = \"L85A2\", a_obj = \"a_o\", stats = {value = 1}, adds = {\"L85A2_unit\", \"wpn_fps_upg_o_mbus_front\"}},wpn_fps_upg_o_mbus_front = {a_obj = \"a_os\", parent = \"foregrip\"}"
	},
	jp = { 
	...
	moe = { 
		...
		override = "wpn_fps_m4_uupg_b_short_vanilla = {parent = \"m16\"}, wpn_fps_ass_m16_os_frontsight = {a_obj = \"a_ns\",parent = \"d_extender\", adds = {\"extender_ap\"}}, wpn_fps_m4_uupg_b_sd = {adds = {\"barrel_extender_jp_smr\"},a_obj = \"a_ns\",parent = \"b_extender\"}, wpn_fps_m4_uupg_b_sd_dummy = {adds = {\"barrel_extender_jp_smr\"}, a_obj = \"a_ns\", parent = \"b_extender\"}, wpn_fps_m4_uupg_b_sd_dummy_thin = {adds = {\"barrel_extender_jp_smr\"}, a_obj = \"a_ns\", parent = \"b_extender\"}, wpn_fps_upg_o_dd_rear = {parent = \"L85A2\", a_obj = \"a_o\", adds = {\"L85A2_unit\", \"wpn_fps_upg_o_dd_front\"}},wpn_fps_upg_o_dd_front = {a_obj = \"a_os\", parent = \"foregrip\"},wpn_fps_upg_o_mbus_rear = {parent = \"L85A2\", a_obj = \"a_o\", stats = {value = 1}, adds = {\"L85A2_unit\", \"wpn_fps_upg_o_mbus_front\"}}, wpn_fps_upg_o_mbus_front = {a_obj = \"a_os\", parent = \"foregrip\"}, wpn_fps_m4_uupg_o_flipup = { unit = \"units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_o_flipup_emo\", third_unit = \"units/payday2/weapons/wpn_third_ass_m4_pts/wpn_third_m4_uupg_o_flipup_emo\"}"
	},
	lvoa = { 
	...
	colt = { 
		...
		override = "wpn_fps_ass_m16_os_frontsight = { parent = \"amcar\"}, wpn_fps_upg_o_dd_rear = {parent = \"L85A2\", a_obj = \"a_o\", adds = {\"L85A2_unit\", \"wpn_fps_upg_o_dd_front\"}}, wpn_fps_upg_o_dd_front = {a_obj = \"a_fl\",	parent = \"g26_os\", adds = {\"g26_unit_os\"}}, wpn_fps_upg_o_mbus_rear = {parent = \"L85A2\", a_obj = \"a_o\", stats = {value = 1}, adds = {\"L85A2_unit\", \"wpn_fps_upg_o_mbus_front\"}}, wpn_fps_upg_o_mbus_front = {a_obj = \"a_fl\",	parent = \"g26_os\", adds = {\"g26_unit_os\"}}"
	},
	m16 = { 
		...
		override = "wpn_fps_m4_uupg_b_short_vanilla = { unit = \"units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_b_medium\",third_unit = \"units/payday2/weapons/wpn_third_ass_m4_pts/wpn_third_m4_uupg_b_medium\"},wpn_fps_m4_uupg_b_medium_vanilla = { parent = \"m16\" },wpn_fps_ass_m16_os_frontsight = { parent = \"m16\" }, wpn_fps_m4_uupg_b_sd = {unit = \"units/pd2_dlc_gage_jobs/weapons/wpn_fps_upg_fg_smr/wpn_fps_m4_upg_b_sd_smr\",third_unit = \"units/pd2_dlc_gage_jobs/weapons/wpn_third_upg_fg_smr/wpn_third_m4_upg_b_sd_smr\",adds = {\"barrel_extender_jp_smr\"},a_obj = \"a_ns\",parent = \"b_extender\"}, wpn_fps_m4_uupg_b_sd_dummy = {unit = \"units/pd2_dlc_gage_jobs/weapons/wpn_fps_upg_fg_smr/wpn_fps_m4_upg_b_sd_smr\",third_unit = \"units/pd2_dlc_gage_jobs/weapons/wpn_third_upg_fg_smr/wpn_third_m4_upg_b_sd_smr\",adds = {\"barrel_extender_jp_smr\"},a_obj = \"a_ns\",parent = \"b_extender\"}, wpn_fps_m4_uupg_b_sd_dummy_thin = {unit = \"units/pd2_dlc_gage_jobs/weapons/wpn_fps_upg_fg_smr/wpn_fps_m4_upg_b_sd_smr\",third_unit = \"units/pd2_dlc_gage_jobs/weapons/wpn_third_upg_fg_smr/wpn_third_m4_upg_b_sd_smr\",adds = {\"barrel_extender_jp_smr\"},a_obj = \"a_ns\",parent = \"b_extender\"}, wpn_fps_upg_o_dd_rear = {parent = \"L85A2\", a_obj = \"a_o\", adds = {\"L85A2_unit\", \"wpn_fps_upg_o_dd_front\"}}, wpn_fps_upg_o_dd_front = {a_obj = \"a_fl\", parent = \"g26_dos\", adds = {\"g26_unit_os\"}},wpn_fps_upg_o_mbus_rear = { parent = \"L85A2\", a_obj = \"a_o\", stats = {value = 1}, adds = {\"L85A2_unit\", \"wpn_fps_upg_o_mbus_front\" }}, wpn_fps_upg_o_mbus_front = {a_obj = \"a_fl\", parent = \"g26_dos\", adds = {\"g26_unit_os\"}}, wpn_fps_m4_uupg_o_flipup = { unit = \"units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_o_flipup_emo\", third_unit = \"units/payday2/weapons/wpn_third_ass_m4_pts/wpn_third_m4_uupg_o_flipup_emo\"}"
	},
	m16Railed = { 
...
local car4_override = "tweak_data.weapon.factory.wpn_fps_ass_m4.override = { wpn_fps_m4_lower_reciever = { adds = {  \"amcar_unit\",	\"m16_unit\", \"olympic_unit\" }}, wpn_fps_upg_ass_m4_lower_reciever_core = { adds = { \"amcar_unit\",	\"m16_unit\", \"olympic_unit\" }}, wpn_fps_upg_bp_lmg_lionbipod = { parent = \"m249\", adds = { \"L85A2_unit_bp\" }},  wpn_fps_upg_vg_ass_smg_afg = { parent = \"m16\" }, wpn_fps_m4_uupg_b_short = { unit = \"units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_b_dummy\", third_unit = \"units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_b_dummy\", adds = { \"wpn_fps_m4_uupg_b_short_vanilla\" } }," 
...
if GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 ~= 1 or GageUpgradeOptions._opts.CAR4.Foregrips._sight_lr300_car4 ~= 1 or GageUpgradeOptions._opts.CAR4.Foregrips._optic_gadget_lr300_car4 ~= 1 then
	over_fg = fg.lr300.unit_name .. " = {"
	over_fg_sights = fg.lr300.override
	override = "override = {"
			
	if GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 2 then 
		over_fg = over_fg .. fg.rail.units .. ","
		over_fg_sights = fg.rail.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 3 then
		over_fg = over_fg .. fg.jp.units .. ","
		over_fg_sights = fg.jp.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 4 then
		over_fg = over_fg .. fg.smr.units .. ","
		over_fg_sights = fg.smr.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 5 then
		over_fg = over_fg .. fg.moe.units .. ","
		over_fg_sights = fg.moe.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 6 then
		over_fg = over_fg .. fg.lvoa.units .. ","
		over_fg_sights = fg.lvoa.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 7 then
		over_fg = over_fg .. fg.colt.units .. ","
		over_fg_sights = fg.colt.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 8 then
		over_fg = over_fg .. fg.m16.units .. ","
		over_fg_sights = fg.m16.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 9 then
		over_fg = over_fg .. fg.m16Railed.units .. ","
		over_fg_sights = fg.m16Railed.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 10 then
		over_fg = over_fg ..fg.m16Vietnam.units .. ","
		over_fg_sights = fg.m16Vietnam.override
	elseif GageUpgradeOptions._opts.CAR4.Foregrips._lr300_foregrip_car4 == 11 then
		over_fg = over_fg .. fg.m16Stag.units .. ","
		over_fg_sights = fg.m16Stag.override
	end
	...
	if GageUpgradeOptions._opts.CAR4.Foregrips._sight_lr300_car4 ~= 1 or GageUpgradeOptions._opts.CAR4.Foregrips._optic_gadget_lr300_car4 ~= 1 then	
		...
		elseif GageUpgradeOptions._opts.CAR4.Foregrips._sight_lr300_car4 == 5 then
			override = override .. sight.ksgFs.. ",";
		elseif GageUpgradeOptions._opts.CAR4.Foregrips._sight_lr300_car4 == 6 then
			override = override .. sight.mbusFs .. ",";
...
--	Pro Grip
grip = ""
if GageUpgradeOptions._opts.CAR4.Grips._pro_grip_car4 ~= 1 then
...
if GageUpgradeOptions._opts.CAR4.Barrels._big_suppressor_replace_car4 then
	...
	if GageUpgradeOptions._opts.CAR4.Barrels._use_thin_big_car4 then
		...
		tweak_data.weapon.factory.wpn_fps_ass_m4.override.wpn_fps_upg_ns_ass_smg_large.forbids = {}
	end
end	
...
if GageUpgradeOptions._opts.CAR4.Barrels._medium_suppressor_replace_car4 then
	...
	if GageUpgradeOptions._opts.CAR4.Barrels._use_thin_medium_car4 then
		...
		tweak_data.weapon.factory.wpn_fps_ass_m4.override.wpn_fps_upg_ns_ass_smg_medium.forbids = {}
	end
end	
...
if GageUpgradeOptions._opts.CAR4.Barrels._low_profile_suppressor_replace_car4 then
	...
	if GageUpgradeOptions._opts.CAR4.Barrels._use_thin_low_profile_car4 then
        ...
        tweak_data.weapon.factory.wpn_fps_ass_m4.override.wpn_fps_upg_ns_ass_smg_small.forbids = {}
	end
end	

-- AMR-16 Customization  
-- TODO: AMR16 Customization
local amr16_override = "tweak_data.weapon.factory.wpn_fps_ass_m16.override = { wpn_fps_upg_ass_m4_b_beowulf = {stats = {			value = 1,spread = 4,recoil = -4,total_ammo_mod = -4,damage = 80,concealment = -4}, custom_stats = {ammo_pickup_min_mul = 0.8, ammo_pickup_max_mul = 0.8}}, wpn_fps_m4_lower_reciever = { adds = { \"L85A2_unit\" }}, wpn_fps_upg_ass_m4_lower_reciever_core = { adds = { \"L85A2_unit\" }}, wpn_fps_upg_bp_lmg_lionbipod = { parent = \"m249\"},  wpn_fps_upg_vg_ass_smg_afg = { parent = \"m16\" }, wpn_fps_m4_uupg_b_short = { unit = \"units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_b_dummy\", third_unit = \"units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_b_dummy\", adds = { \"wpn_fps_m4_uupg_b_short_vanilla\" } }," 
...
tweak_data.weapon.factory.parts.wpn_fps_lmg_m249_upper_reciever.override = {
	wpn_fps_upg_o_rx01 = {
		adds = {"famas_unit", "wpn_fps_pis_rage_o_adapter"},
		override = {
			famas_unit = {
				a_obj = "g_dustcover",
				parent = "upper_reciever",	
			},
			wpn_fps_pis_rage_o_adapter = { parent = "famas" }
		},
		a_obj = "a_o",
		parent = "famas",
		stance_mod = {
